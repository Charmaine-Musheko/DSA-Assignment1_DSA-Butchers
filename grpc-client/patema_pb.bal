...
public isolated client class CarRentalReservationResponseCaller {
...
public isolated client class CarRentalResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class CarRentalCarListCaller {
    private final grpc:Caller caller;
